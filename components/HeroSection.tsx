  ...
  return (
    <section className="relative min-h-screen flex flex-col pt-16 overflow-hidden">
      ...
      <div className="relative w-full max-w-4xl mx-auto px-6 md:px-10 pt-14 md:pt-20 pb-10 flex flex-col items-center text-center">
        ...
        >
          Escaneá tu código de cupón y participá por un Smart TV 85" para disfrutar
          ...
          >
            <div className="mb-7 text-center">
              ...
              <p className="text-xs text-rf-texto/40">
                Completá el formulario con el cupón entregado junto con tu factura. <span className='font-bold'>¡Comentando en la publicación del sorteo en Instagram duplicas tus chances!</span>
              </p>
            </div>
